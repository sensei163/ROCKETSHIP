...
if strcmp(plot_data.model_name,'aif') || strcmp(plot_data.model_name,'tofts')
    ...
    fit_curve_low = model_tofts_cfit(fit_parameters(5),fit_parameters(7),plot_data.Cp,plot_data.timer);
    fit_curve_high = model_tofts_cfit(fit_parameters(6),fit_parameters(8),plot_data.Cp,plot_data.timer);
