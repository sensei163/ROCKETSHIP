...
script_prefs = parse_preference_file('script_preferences.txt', 0, ...
    ...
    'rootname' 'fileorder' 'quant' 'roimaskroi' 'aifmaskroi' 'tr' 'fa' ...
    'hematocrit' 'snr_filter' 'relaxivity' 'injection_time' ...
...
% main function call
A_results = A_make_R1maps_func(filevolume, noise_pathpick, ...
    ...
    aifmaskroi, tr, fa, hematocrit, snr_filter, relaxivity, injection_time, ...
    drift_global, blood_t1, injection_duration);
