...
function [Cp, x, xdata, rsquare] = AIFbiexpfithelplocal(xdata, verbose)
...
[x,resnorm,residual,exitflag,output,lambda,jacobian] = lsqcurvefit(@AIFbiexpconlocal, ...
