...
% check preference file with verbose for invalid selections, use this to
% guard against typos
parse_preference_file('dce_preferences.txt',1,...
    ...
    'force_cpu' 'gpu_tolerance' 'gpu_max_n_iterations' 'gpu_initial_value_ktrans' 'gpu_initial_value_ve' ...
